...
// getRecipesFromSpoonacular utility function to retrieve the recipes from spoonacular given the comma separated products
...
// convertToProtobuf converts the arrays of struct into an array of protobuf.Recipe pointers
...
// connectToRedis connects to the redis container
...
// setEntryInRedis sets a new entry in Redis
...
func main() {
	...
	lis, err := net.Listen("tcp", fmt.Sprintf("%s:%d", "0.0.0.0", properties.RecipesPort))
	if err != nil {
