...
products = ["Pane", "Mortadella", "Pasta"]  # TODO salvare in persistenza
last_week = 20  # TODO salvare in persistenza
...
def time_series_train_test_split(dataset, train_rows):
    data_train = dataset[:train_rows]
    data_test = dataset[train_rows:]
